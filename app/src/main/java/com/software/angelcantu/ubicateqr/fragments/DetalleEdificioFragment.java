...
public class DetalleEdificioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_detalle_edificio, container, false);
        ...
        EdificioModelo miEdificio=null;
        if (objetoEdificio != null) {
            miEdificio= (EdificioModelo) objetoEdificio.getSerializable("objeto");

            asignarInformacion(miEdificio);

        }

        return view;
    }
    public void asignarInformacion(EdificioModelo miEdificio) {
        imagenDetalle.setImageResource(R.drawable.edificiod1);
        textDescripcion.setText(miEdificio.getDescripcion_larga());
    }
